...
namespace Wemail.Mail.ViewModels
{
    public class MailViewModel : BindableBase,INavigationAware
    {
        ...
        private List<MailModel> ConvertToModel(List<MailDTO> contacts)
        {
            ...
            {
                var sender = new ContactModel { Name = mail.Sender.Name, Age = mail.Sender.Age, Mail = mail.Sender.Mail, Phone = mail.Sender.Phone };
                var reciver = new ContactModel { Name = mail.Reciver.Name, Age = mail.Reciver.Age, Mail = mail.Reciver.Mail, Phone = mail.Reciver.Phone};
                var cc = new ContactModel { Name = mail.CC.Name, Age = mail.CC.Age, Mail = mail.CC.Mail, Phone = mail.CC.Phone };
